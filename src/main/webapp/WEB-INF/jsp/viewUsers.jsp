			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="<c:url value="/AdminPanel"/>" style="color:#ffffff;"><i
								class="glyphicon glyphicon-home" ></i> Home</a></li>
						<li><a href="<c:url value="/viewUsersForEnable"/>" style="color:#ffffff;"><i
								class="glyphicon glyphicon-book" ></i> Enable Users</a></li>
						<li><a href="<c:url value="/ChangeUserPasswords"/>" style="color:#ffffff;"><i
								class="glyphicon glyphicon-edit" ></i> Change Password</a></li>
