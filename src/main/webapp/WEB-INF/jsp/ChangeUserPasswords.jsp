					...
					<ul class="nav navbar-nav">
						...
						<li><a href="<c:url value="/viewUsersForEnable"/>"
							style="color: #ffffff;"><i class="glyphicon glyphicon-book"></i>
								Enable Users</a></li>
						<li><a href="<c:url value="/ChangeUserPasswords"/>"
							style="color: #ffffff;"><i class="glyphicon glyphicon-edit"></i>
			...
			<table class="table table-striped table-bordered table-list">
				<thead>
					...
					<tr>
						...
						<th style="color: #1E90FF; text-align: center">Change
							Password</th>
						...
						<tr>
							...
							<td align="center"><a class="btn btn-primary"
								href="<c:url value="/changepassword/${details.userId}"/>"><em
									class="glyphicon ">change password</em></a></td>
